...
import './Home.css'
import sample from '../assets/img_portfolio.png'
  ...
  return (
    <section id='intro'>
      <div className="introContent">
          ...
          <span className='introText'>I'm <span className='introName'>Mohammed Alraffi</span><br />Full Stack Developer</span>
          <p className="introPara">
            I build responsive, accessible and user-friendly web applications. I love converting <br /> designs into clean, 
            functional interfaces and bringing ideas to life with JavaScript.
          </p>
          <Link style={{width : "fit-content"}}><button> <IoIosBriefcase size={18} />Hire Me</button></Link>
      </div>
      <img src={sample} alt="" className='bg'/>
    </section>
  )
}
...
//         <img src={sample} alt="" className="hero-img"/>
//       </div>
//     </section>
//     </>
//   )
